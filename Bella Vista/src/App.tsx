...
import { MenuItem, BasketItem, DeliveryInfo, OrderSummary } from './types';
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <Header 
        ...
        onWineListClick={() => setIsWineListOpen(true)}
        heroRef={heroRef}
        menuRef={menuRef}
        footerRef={footerRef}
      />
      ...
      <div ref={menuRef} className="bg-gradient-to-b from-slate-50 to-white py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Elegant Section Header */}
          <div className="text-center mb-12 sm:mb-20">
            <div className="inline-flex items-center space-x-4 mb-4 sm:mb-6">
              <div className="w-12 sm:w-16 h-px bg-gradient-to-r from-transparent via-amber-400 to-transparent"></div>
              <div className="text-amber-600 text-xs sm:text-sm font-light tracking-[0.3em] uppercase">Menu</div>
              <div className="w-12 sm:w-16 h-px bg-gradient-to-r from-transparent via-amber-400 to-transparent"></div>
            </div>
            
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-serif text-slate-900 mb-4 sm:mb-6 tracking-tight">
              Culinary Excellence
            </h2>
            <p className="text-base sm:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed font-light px-4">
          ...
          {filteredItems.length === 0 && (
            <div className="text-center py-12 sm:py-16">
              <p className="text-slate-600 text-base sm:text-lg font-light mb-4">No dishes found matching your search.</p>
              <button
                onClick={() => {
                  setSearchTerm('');
      ...
      {/* Luxury Footer */}
      <footer ref={footerRef} className="bg-slate-900 text-white py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Main Footer Content */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 mb-12 sm:mb-16">
            {/* Restaurant Info */}
            <div className="lg:col-span-2">
              <h3 className="text-2xl sm:text-3xl font-serif text-amber-300 mb-4 sm:mb-6">Bella Vista</h3>
              <p className="text-slate-300 leading-relaxed mb-4 sm:mb-6 font-light text-sm sm:text-base">
              ...
              <div className="flex items-center space-x-4 sm:space-x-6">
                ...
                <span className="text-slate-400 text-xs sm:text-sm font-light">Michelin Recommended</span>
              </div>
            </div>

            {/* Contact Information */}
            <div>
              <h4 className="text-base sm:text-lg font-medium mb-4 sm:mb-6 text-amber-200">Contact</h4>
              <div className="space-y-3 sm:space-y-4 text-slate-300 font-light text-sm sm:text-base">
            ...
            {/* Hours & Services */}
            <div>
              <h4 className="text-base sm:text-lg font-medium mb-4 sm:mb-6 text-amber-200">Hours & Services</h4>
              <div className="space-y-3 sm:space-y-4 text-slate-300 font-light text-sm sm:text-base">
                <div>
          ...
          <div className="border-t border-slate-800 pt-6 sm:pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-4 sm:space-x-6 mt-4 md:mt-0">
              <button className="text-slate-400 hover:text-amber-300 text-xs sm:text-sm font-light transition-colors">
                Privacy Policy
              </button>
              <button className="text-slate-400 hover:text-amber-300 text-xs sm:text-sm font-light transition-colors">
                Terms of Service
